      ...
      <div className="bg-white shadow-md rounded-lg max-w-4xl mx-auto p-8">
        ...
        <div className="mt-8">
          {[
            ...
            { title: 'Safflower Oil', img: 'http://res.cloudinary.com/dxwax6pir/image/upload/v1725643584/faeki1uz0x1mkenqgufe.jpg', benefits: ['Lowers the risk of cardiovascular diseases', 'Boosts metabolism and reduces body fat', 'Rich in omega-6 fatty acid', 'Acts as a natural moisturizer for the skin', 'Helps to regulate blood sugar levels'] },
            { title: 'Neem Oil', img: "http://res.cloudinary.com/dxwax6pir/image/upload/v1725639124/bisqiamhy4rbfln7irvl.jpg", benefits: ['Has antibacterial and antifungal properties', 'Supports healthy skin and hair', 'Can be used as an insect repellent', 'Helps to treat acne and skin infections', 'Used in natural pesticide formulations'] },
            ...
            { title: 'Almond Oil', img: "http://res.cloudinary.com/dxwax6pir/image/upload/v1725638166/patypywfbrbgadiamwhz.jpg", benefits: ['Promotes heart health', 'Supports healthy skin', 'May reduce the risk of chronic diseases', 'Good for weight management', 'Rich in antioxidants'] },
            { title: 'Eucalyptus Oil', img: "http://res.cloudinary.com/dxwax6pir/image/upload/v1725643019/c6g9qavx8sjwgncgpml8.jpg", benefits: ['Helps to clear nasal congestion', 'Has antibacterial and antiviral properties', 'Used in aromatherapy for relaxation', 'Supports respiratory health', 'Can be used as an insect repellent'] },
