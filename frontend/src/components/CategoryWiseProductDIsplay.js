...
const CategoryWiseProductDisplay = ({ category, heading }) => {
    ...
    return (
        <div className="container mx-auto px-7 my-6 relative">
            ...
            <div className=" grid grid-cols-[repeat(auto-fit,minmax(300px,300px))] justify-between md:gap-6 overflow-scroll h-full scrollbar-none transition-all">
                ...
                {loading
                    ...
                    : data.map((product, index) => {
                        return (
                            <Link to={"/product/"+product?._id} key={index} className="w-full min-w-[230px] md:min-w-[320px] max-w-[230px]  md:max-w-[320px] h-full bg-white rounded-sm shadow-md" onClick={scrollToTop()}>
